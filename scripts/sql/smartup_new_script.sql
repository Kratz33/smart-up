...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 17 Novembre 2016 à 09:18
...
INSERT INTO `categories` (`id`, `label`, `niveau`, `categ_id`) VALUES
(1, 'Marketing', 1, NULL),
(2, 'Comptabilité', 1, NULL),
(4, 'Financement', 1, NULL),
(5, 'Business Model', 1, NULL),
(6, 'Technique', 1, NULL),
(7, 'Juridique', 1, NULL),
(8, 'Vente', 1, NULL),
(10, 'Freelance', 1, NULL),
(11, 'Entrepreneur', 1, NULL);
...
(8, 'test', '2016-11-15 15:02:18', 349, 10),
(9, 'test', '2016-11-15 15:03:01', 349, 10),
(10, 'Ouaiis !', '2016-11-15 20:20:56', 349, 13),
(11, 'Ouaiis !', '2016-11-15 20:21:17', 349, 13),
(12, 'test notif ? :D', '2016-11-16 19:21:55', 349, 13),
(13, 'test notif ? :D', '2016-11-16 19:23:51', 349, 13),
(14, 'test notif ? :D', '2016-11-16 19:29:11', 349, 13),
(15, 'test', '2016-11-16 19:37:58', 353, 13);
...
(12, '2016-11-16 19:29:11', 0, 13, 349, 'Votre post a reçu une réponse de la part deTEST3'),
(13, '2016-11-16 19:37:59', 0, 13, 353, 'Votre post a reçu une réponse de la part deTEST3');
...
INSERT INTO `posts` (`id`, `message`, `date`, `titre`, `id_utilisateur`, `id_categorie`) VALUES
...
(350, 'uhyjikolpm', '2016-11-16 18:29:34', 'Tentative de notif ', 13, 1),
(351, 'rrererer', '2016-11-16 18:32:14', 'eeee', 13, 1),
(352, 'BLAAAA', '2016-11-16 18:35:56', 'BLAAA', 13, 1),
(353, 'BLAAAA', '2016-11-16 18:38:54', 'BLAAA', 13, 1);
...
INSERT INTO `utilisateurs` (`id`, `pseudo`, `nom`, `prenom`, `mail`, `mdp`, `premium`, `description`, `profil`, `type_id`) VALUES
(1, 'Eviliscious', 'De Balle', 'Trou', 'troudbal@gmail.com', 'luvluv', 0, '', 'membre', NULL),
(2, 'Steele1664', 'eeeeee', 'eeee', 'eee@g.fr', 'eeeeee', 0, '', 'membre', NULL),
(3, 'Oui', 'Non', 'Peut etre', 'kookjokj@gmail.lol', '666666', 0, '', 'membre', NULL),
(4, 'Regen', 'Furgaute', 'Yohanneee', 'yohannfurgaut@gmail.com', 'Steele1664', 0, '', 'membre', NULL),
(5, 'Kratz', 'eeeededeeeee', 'Yohanneee', 'yohannfurgaut@gmail.com', 'Kro1664', 0, '', 'membre', NULL),
(6, 'Regeeeeen', 'Furgaut', 'Yohann', 'kookokko@gmail.com', '820e13451d919f39043b634684c80171', 0, '', 'membre', NULL),
(8, 'Hola', 'ijijijij', 'ijijijijij', 'ijijij@gmail.com', '820e13451d919f39043b634684c80171', 0, '', 'membre', NULL),
(9, 'Kratzaaaa', 'kkkk', 'kkkk', 'kk@k.fr', '820e13451d919f39043b634684c80171', 0, '', 'membre', NULL),
(10, 'Nozkrew', 'Test', 'Thomas', 'thomas.test@mail.fr', 'ef6e65efc188e7dffd7335b646a85a21', 0, '', 'membre', NULL),
(11, 'test2', 'test', 'test', 'yohannfurgaut@gmail.com', '05a671c66aefea124cc08b76ea6d30bb', 0, '', 'membre', NULL),
(13, 'TEST3', 'test', 'test', 'yohannfurgaut@gmail.com', '05a671c66aefea124cc08b76ea6d30bb', 0, '', 'membre', 2),
(14, 'kiki', 'kiki', 'kiki', 'okok@gmail.com', 'ef592c87c9ff628ae52bf96a796de2f3', 0, '', 'membre', NULL);

-- --------------------------------------------------------

--
-- Structure de la table `util_categ`
--
...
--
-- Contenu de la table `util_categ`
--

INSERT INTO `util_categ` (`utilisateur_id`, `categorie_id`) VALUES
(13, 1),
(10, 1),
(3, 1),
(2, 1),
...
INSERT INTO `vote` (`id`, `valeur`, `utilisateur_id`, `commentaire_id`) VALUES
(35, -1, 11, 8),
(119, -1, 13, 11),
(148, 1, 13, 10),
(158, 1, 13, 8);
...
ALTER TABLE `categories`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_categories_categories` (`categ_id`);
...
ALTER TABLE `utilisateurs`
  ...
  ADD KEY `FK_utilisateurs_type` (`type_id`);

--
-- Index pour la table `util_categ`
--
ALTER TABLE `util_categ`
  ADD KEY `FK_util_categ_utilisateurs` (`utilisateur_id`),
  ADD KEY `FK_util_categ_categories` (`categorie_id`);
...
ALTER TABLE `vote`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_vote_utilisateurs` (`utilisateur_id`),
  ADD KEY `FK_vote_commentaires` (`commentaire_id`);
...
--
ALTER TABLE `categories`
  ADD CONSTRAINT `FK_categories_categories` FOREIGN KEY (`categ_id`) REFERENCES `categories` (`id`);

--
-- Contraintes pour la table `commentaires`
--
ALTER TABLE `commentaires`
  ADD CONSTRAINT `fk_comm_bill` FOREIGN KEY (`id_billet`) REFERENCES `posts` (`id`),
...
--
ALTER TABLE `utilisateurs`
  ADD CONSTRAINT `FK_utilisateurs_type` FOREIGN KEY (`type_id`) REFERENCES `type` (`id`);

--
-- Contraintes pour la table `util_categ`
--
ALTER TABLE `util_categ`
  ADD CONSTRAINT `FK_util_categ_categories` FOREIGN KEY (`categorie_id`) REFERENCES `categories` (`id`),
  ADD CONSTRAINT `FK_util_categ_utilisateurs` FOREIGN KEY (`utilisateur_id`) REFERENCES `utilisateurs` (`id`);

--
-- Contraintes pour la table `vote`
--
ALTER TABLE `vote`
  ADD CONSTRAINT `FK_vote_commentaires` FOREIGN KEY (`commentaire_id`) REFERENCES `commentaires` (`id`),
  ADD CONSTRAINT `FK_vote_utilisateurs` FOREIGN KEY (`utilisateur_id`) REFERENCES `utilisateurs` (`id`);
